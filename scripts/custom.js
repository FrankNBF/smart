function loadPage() {
    ...
    $(document).on("click", ".material-menu-deploy", function() {
	...
	$(document).on("click", ".material-menu-close, .material-menu-background", function() {
    ...
    //Header Menu*/
	$(document).on("click", ".open-header-menu, .close-header-menu", function() {
    ...
    //Modal Menu*/
	$(document).on("click", ".open-modal-menu, .close-modal-menu, .modal-menu-background", function() {
	...
	//console.log('Custom js is ready and loaded');
